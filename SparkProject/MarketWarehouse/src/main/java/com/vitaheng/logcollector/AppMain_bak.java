package com.vitaheng.logcollector;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.vitaheng.logcollector.bean.*;
...
public class AppMain_bak {
    private final static Logger logger = LoggerFactory.getLogger(AppMain_bak.class);
    ...
    public static void main(String[] args) {
        ...
        // 参数二：循环遍历次数
        int loop_len = args.length > 1 ? Integer.parseInt(args[1]) : 100;
